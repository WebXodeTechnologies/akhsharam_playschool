...
const AnimatedTooltip = () => {
  return (
    <section className="w-full px-4 sm:px-8 md:px-12 lg:px-24 py-12]">
      <div className="text-center mb-10">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
          Loved by Parents, Trusted for Learning
        </h2>
        <p className="text-gray-600 text-sm sm:text-base mt-2">
          Real voices. True stories. Heartfelt experiences.
        </p>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-6 sm:gap-10">
        {team.map((person, index) => (
          ...
          >
            ...
            {/* Tooltip */}
            <div className="absolute top-[110%] left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-y-1 bg-black text-white text-xs rounded px-3 py-2 whitespace-nowrap z-10 shadow-md pointer-events-none">
